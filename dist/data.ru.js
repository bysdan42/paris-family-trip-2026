...
export const documents = {
  "transferOutbound": {
    "title": "Подтверждение трансфера · Орли — Explorers",
    "type": "HTML · сводка подтверждения · иврит и русский",
    "path": "./documents/transfer-outbound-summary.html",
    "description": "28.9.2026 · 23:00 · Paris Eagle Cab · минивэн на 7 · Орли — Explorers · 2 бустера · остаток €113.30, оплата водителю картой. Публичная сводка подтверждения.",
    "status": "Трансфер подтверждён"
  },
  "transferReturn": {
    "title": "Подтверждение трансфера · Edgar — Орли",
    "type": "HTML · сводка подтверждения · иврит и русский",
    "path": "./documents/transfer-return-summary.html",
    "description": "7.10.2026 · 07:30 · Paris Eagle Cab · минивэн на 7 · Edgar Suites Hameau — Орли · 2 бустера · остаток €92.70, оплата водителю картой. Публичная сводка подтверждения.",
    "status": "Трансфер подтверждён"
  },
  "edgar": {
...
export const days = [
  {
    ...
    "baggage": {
      "sections": [
        {
          "title": "Небольшая сумка каждому",
          "text": "Одна сумка до 40 × 30 × 20 см под сиденьем. Ручная кладь — до 10 кг на пассажира."
        },
        {
          "title": "Чемодан в салон",
          "text": "До 55 × 40 × 25 см, за доплату или в тарифе, где он включён. В предоставленном подтверждении такая покупка не указана. При добавлении чемодан и небольшая сумка вместе — до 10 кг. Размеры включают колёса и ручки."
        },
        {
          "title": "Распределение багажа",
          "text": "Это нормы веса, а не количество чемоданов. В рамках одного бронирования вес можно распределить между пассажирами при совместной сдаче багажа. Каждый чемодан: до 32 кг и до 165 см по сумме длины, ширины и высоты, включая колёса и ручки."
        },
        {
          "title": "Детские коляски",
          "text": "Одна коляска до 10 кг на ребёнка бесплатно, дополнительно к остальному багажу, по правилам Transavia."
        }
      ],
      "sourceNote": "Источник: письмо с подтверждением рейсов от 10.6.2026; правила Transavia проверены 16.9.2026. Более поздние изменения бронирования в письме не отражены.",
      "sources": [
        {
          "title": "Правила сдаваемого багажа",
          "url": "https://www.transavia.com/help/en-eu/baggage/checked-baggage/checked-baggage-rules"
        },
        {
          "title": "Правила ручной клади",
          "url": "https://www.transavia.com/help/en-nl/baggage/cabin-baggage/cabin-bag"
        }
      ],
      "title": "Багаж · туда 28.9",
      "total": "60 кг сдаваемого багажа",
      "allowances": [
        "Дан, дедушка и Мири: по 20 кг каждому.",
        "Ариэль, Лиз, Тай и Тони: в подтверждении рейса туда сдаваемый багаж не указан."
      ]
    },
    "date": "28.9",
    "weekday": "Понедельник",
    ...
    "transport": "Перелёт + подтверждённый трансфер Paris Eagle Cab",
    "documents": [
      "outbound",
      "transferOutbound",
      "disney",
    ...
    "notes": [
      ...
      "Обратите внимание: в подтверждении трансфера указано 23:00 — всего через 20 минут после посадки в 22:40. Уточните у компании, что водитель дождётся прохождения паспортного контроля и получения багажа; время бронирования на сайте не изменено.",
      "В каждом трансфере: минивэн на 7 пассажиров, 7 небольших и 3 больших места багажа, 2 бустера и 0 детских кресел по подтверждению.",
      "Остаток по подтверждению: €113.30, оплата водителю картой; оплачено €0. В подтверждении также указана ночная доплата €10.",
      "Встреча в Орли: водитель ждёт с табличкой в зале прилёта. Держите телефон включённым и покажите водителю оригинал письма. Помощь компании по телефону и WhatsApp: +33 6 98 84 28 28."
    ],
    "events": [
      {
        "time": "18:35",
      ...
      {
        "time": "23:00",
        "title": "Трансфер из Орли в Explorers",
        "description": "Paris Eagle Cab · время из подтверждения. Минивэн на семерых, 2 бустера, 7 небольших и 3 больших места багажа. Встреча с табличкой в зале прилёта; остаток €113.30, оплата водителю картой. Уточните ожидание после посадки.",
        "group": [
          "dan",
          "grandpa",
          "miri",
    ...
    "options": [
      {
        "title": "Трансфер уже забронирован",
        "description": "Paris Eagle Cab из Орли в Explorers по приложенной сводке. Изменение времени или количества багажа согласуйте с компанией.",
        "group": [
          "dan",
          "grandpa",
          "miri",
  ...
  },
  {
    ...
    "baggage": {
      ...
      "title": "Багаж · обратно 7.10",
      "total": "80 кг сдаваемого багажа",
      "allowances": [
        "Дан, дедушка, Мири и Ариэль: по 20 кг каждому.",
        "Лиз, Тай и Тони: в подтверждении обратного рейса сдаваемый багаж не указан."
      ]
    },
    "date": "6.10",
    "weekday": "Вторник",
    ...
    "notes": [
      ...
      "Обратный трансфер забронирован на 7.10, 07:30. Заранее соберите вещи, подготовьте подтверждение и карту для оплаты водителю €92.70. В трансфере указаны 3 больших чемодана; если их будет больше, сообщите компании."
    ],
    "events": [
      {
        "time": "Утро",
      ...
      },
      {
        ...
        "description": "Готовим багаж и документы; трансфер Paris Eagle Cab заказан на завтра, 07:30. Подготовьте карту для оплаты остатка водителю.",
        "group": [
          "dan",
          "grandpa",
          "miri",
  ...
  },
  {
    ...
    "transport": "Трансфер Paris Eagle Cab в 07:30 + обратный рейс",
    "documents": [
      "edgar",
      "inbound",
      "transferReturn",
    ...
    "missing": [],
    "notes": [
      "Подтверждённый выезд в 07:30 из Edgar Suites Hameau, 38 Rue du Hameau. По инструкции компании при выезде из апартаментов нужно ждать снаружи. Уточните точное место встречи и время прибытия в аэропорт к рейсу в 10:30.",
      "В каждом трансфере: минивэн на 7 пассажиров, 7 небольших и 3 больших места багажа, 2 бустера и 0 детских кресел по подтверждению.",
      "Остаток по подтверждению: €92.70, оплата водителю картой; оплачено €0. Общий остаток за оба трансфера: €206.00.",
    ...
    "events": [
      {
        ...
        "description": "Paris Eagle Cab · подтверждённый выезд из Edgar Suites Hameau. Минивэн на семерых, 2 бустера, 7 небольших и 3 больших места багажа. Ждём снаружи; остаток €92.70, оплата водителю картой.",
        "group": [
          "dan",
          "grandpa",
          "miri",
    ...
    "options": [
      {
        ...
        "description": "Подтверждённое время выезда — 07:30. Если для соблюдения требований авиакомпании нужен более ранний выезд, запросите изменение у перевозчика и дождитесь нового подтверждения.",
        "group": [
          "dan",
          "grandpa",
          "miri",
